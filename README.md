...
- libwebsocket v4.1.4, build with LWS_MAX_SMP=1, ipv6=true for single thread processing
- libsrtp v2.3.0
- ffmpeg n4.3.1 with vpx, libx264, alsa(for headless chrome screen caputreing)
- gstreamer installation from gstreamer1.0-tools. (WIP for meson ninja build)
- coturn v4.5.1.3 in order to test turn, use iceTransportPolicy=relay https://www.w3.org/TR/webrtc/#rtcicetransportpolicy-enum 
- openresty 1.15.8.3
...
- libnice v0.1.18 https://github.com/libnice/libnice/releases/tag/0.1.14 
- golang 1.15.3 for building boringssl
